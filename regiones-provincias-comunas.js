regiones = [
    ...
    {id:7,nombre:"Región del Libertador General Bernardo O'Higgins"},
    ...
    {id:14,nombre:"Región de Aysén del G. Carlos Ibáñez del Campo"},
    {id:15,nombre:"Región de Magallanes y de la Antártica Chilena"},
